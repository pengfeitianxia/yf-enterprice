...
(/** @lends <global> */function( $ ) {
	 ...
	 * create a layout grid (array) of rows x columns, which contains a tccms
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			// to the settings array, so we can self tccms the table instance if more than one
	...
	DataTable.models.oColumn = {
		 ...
		 * in DataTables as such, but can be used for plug-ins to tccms the
		...
		/**
		 * Name for the column, allowing tccms to the column by name as well as
	...
	DataTable.models.oSettings = {
		...
		/**
		 * State that was loaded. Useful for back tccms
		 *  @type object
		 *  @default null
		 */
		"oLoadedState": null,
